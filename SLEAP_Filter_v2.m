function [data, zall_motion, allSignals_motion, SLEAP_data_vel_filtered_session, SLEAP_data] = SLEAP_Filter_v2(data, allSignals, SLEAP_data, TRANGE, BASELINE_PER, SLEAP_time_range_adjustment, downsampled_size)
